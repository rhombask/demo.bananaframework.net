<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserInfo.ascx.cs" Inherits="demo.bananaframework.net.Controllers.Xenon.UserInfo" %>
...
<nav class="navbar user-info-navbar" role="navigation">
	...
	<ul class="user-info-menu right-links list-inline list-unstyled">
		<li class="search-form">
			...
			<button type="submit" class="btn btn-link" style="margin-top: 25px;">
