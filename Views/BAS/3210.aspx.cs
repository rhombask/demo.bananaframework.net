...
namespace demo.bananaframework.net.Views.BAS
{
    ...
    /// </summary>
    public partial class _3210 : Controllers.BasePage
    {
        ...
        {
            Response.Redirect("/Views/BAS/3200.aspx", false);
        }
        #endregion
        ...
        protected void _btnDel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                BANANA.Web.NotificationBar.Show("삭제하였습니다.", BANANA.Web.NotificationBar.NotificationType.Info, 2000, "location.href='/Views/BAS/3200.aspx';");
            }
            catch (Exception err)
            {
                BANANA.Web.NotificationBar.Show(err.Message, BANANA.Web.NotificationBar.NotificationType.Error);
