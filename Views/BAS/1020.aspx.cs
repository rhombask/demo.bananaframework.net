...
namespace demo.bananaframework.net.Views.BAS
{
	...
	/// 설  명: 
	/// </summary>
	public partial class _1020 : Controllers.BasePage
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			if (!IsPostBack)
			{
				try
				{
					...
					if (_total_code != "")
					{
						DataTable _dt		= base.GetDataTable("WSP_BAS1000_R3"
							, _total_code
							);
					...
					{
						_lblMAIN_CODE.Text			= base.GetQueryString("MAIN_CODE");
						_chkDISPLAYYN.Checked		= true;
					}
				}
				catch (Exception err)
				{
		...
		protected void _btnSave_Click(object sender, EventArgs e)
		{
			try
			{
				...
				{
					base.ExecuteNonQuery("WSP_BAS1000_C2"
				...
				{
					base.ExecuteNonQuery("WSP_BAS1000_U2"
		...
		{
			Response.Redirect("/View/BAS/1000.aspx", false);
		}
		#endregion
		...
		protected void _btnDel_Click(object sender, EventArgs e)
		{
			try
			{
				base.ExecuteNonQuery("WSP_BAS1000_D2"
					, _lblTOTAL_CODE.Text
					);

				BANANA.Web.NotificationBar.Show("삭제하였습니다.", BANANA.Web.NotificationBar.NotificationType.Info, 2000, "location.href='/View/BAS/1000.aspx';");
			}
			catch (Exception err)
			{
				BANANA.Web.NotificationBar.Show(err.Message, BANANA.Web.NotificationBar.NotificationType.Error);
