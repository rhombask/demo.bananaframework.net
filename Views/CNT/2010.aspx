<%@ Page Title="대리점정보 등록/수정" Language="C#" MasterPageFile="~/Controllers/Popup.Master" AutoEventWireup="true" CodeBehind="2010.aspx.cs" Inherits="demo.bananaframework.net.Views.CNT._2010" %>
	...
	<fieldset>
		...
		<table class="infoTable">
			...
			<tr>
				...
				<td class="inputCol" colspan="5"><bf:TextBox ID="_txtPRSDNT_ADDR" runat="server" Width="816px" /></td>
			</tr>
			<tr>
				...
				<td class="inputCol"><bf:CodeHelper ID="_chPRNT_CNT_CD" runat="server" CodeHelperType="Branch" Compulsory="True" ValidationGroup="Save" /></td>
				<td class="infoCol"></td>
