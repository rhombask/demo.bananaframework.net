...
if (!DevExpress.MOD_FRAMEWORK) {
    ...
    /*! Module framework, file framework.aspx.js */
    (function($, DX, undefined) {
        DX.framework.aspx = {
            layoutControllers: [],
            layoutSets: {}
    ...
    (function($, DX) {
        ...
        var adapters = DX.framework.aspx.commandToDXWidgetAdapters = {};
        ...
        DX.framework.aspx.WidgetItemWrapperBase = WidgetItemWrapperBase;
        DX.framework.aspx.WidgetAdapterBase = WidgetAdapterBase
    })(jQuery, DevExpress);
    ...
    (function($, DX, undefined) {
        ...
        DX.framework.aspx.CommandManager = Class.inherit({
            ctor: function(options) {
                options = options || {};
            ...
            _getContainerAdapter: function($container) {
                var componentNames = $container.data("dxComponents"),
                    adapters = DX.framework.aspx.commandToDXWidgetAdapters;
                if (componentNames)
    ...
    (function($, DX, undefined) {
        ...
        DX.framework.aspx.DefaultLayoutController = Class.inherit({
            ctor: function(options) {
                options = options || {};
            ...
            _executeTransitions: function(transitions) {
                ...
                var animatedTransitions = $.map(transitions, function(transitionOptions) {
                        ...
                        if (transitionOptions.source.children().length)
                            return DX.framework.aspx.TransitionExecutor.create(transitionOptions.destination, transitionOptions)
                    });
        ...
        layoutSets["default"].push({controller: new DX.framework.aspx.DefaultLayoutController})
    })(jQuery, DevExpress);
    /*! Module framework, file framework.templateEngine.js */
    (function($, DX, undefined) {
        var Class = DX.Class;
        DX.framework.aspx.KnockoutJSTemplateEngine = Class.inherit({applyTemplate: function(template, model) {
    ...
    (function($, DX, undefined) {
        ...
        DX.framework.aspx.ViewEngine = Class.inherit({
            ctor: function(options) {
                options = options || {};
    ...
    /*! Module framework, file framework.aspxApplication.js */
    (function($, DX, undefined) {
        var frameworkNS = DX.framework,
            htmlNS = frameworkNS.aspx;
        ...
        htmlNS.HtmlApplication = frameworkNS.Application.inherit({
            ctor: function(options) {
                ...
                var layoutSets = DX.framework.aspx.layoutSets;
                this.commandManager = options.commandManager || new DX.framework.aspx.CommandManager({commandMapping: this.commandMapping});
                $.each(options.layoutControllers || DX.framework.aspx.layoutControllers, function(_, layoutControllerInfo) {
            ...
            _resolveLayoutControllerImpl: function(viewInfo) {
                ...
                if (!matches.length)
                    throw Error("The layout controller cannot be resolved. There are no appropriate layout controllers for the current context. Make sure you have the corresponding *.js references in your main *.aspx file.");
                if (matches.length > 1)
    ...
    (function($, DX) {
        ...
        DX.framework.aspx.TransitionExecutor = TransitionExecutor;
        DX.framework.aspx.NoneTransitionExecutor = NoneTransitionExecutor;
        DX.framework.aspx.SlideIOS7TransitionExecutor = SlideIOS7TransitionExecutor;
        DX.framework.aspx.SlideTransitionExecutor = SlideTransitionExecutor;
        DX.framework.aspx.OverflowTransitionExecutor = OverflowTransitionExecutor;
        DX.framework.aspx.FadeTransitionExecutor = FadeTransitionExecutor
    })(jQuery, DevExpress);
