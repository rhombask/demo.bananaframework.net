...
if (!window.DevExpress) {
    ...
    (function($, DX, undefined) {
        ...
        var FB = social.Facebook = {
                loginRedirectUrl: "FacebookLoginCallback.aspx",
        ...
        var login = function(appId, options) {
                ...
                options = options || {};
                if (cordovaMode)
                    pendingLoginRedirectUrl = "https://www.facebook.com/connect/login_success.aspx";
                else
    ...
    (function($, DX, undefined) {
        ...
        var originalHtml = $.fn.aspx;
        $.fn.aspx = function(value) {
            if (typeof value === "string")
                cleanKoData(this, false);
    ...
    (function($, DX, undefined) {
        ...
        var DEFAULT_ITEM_TEMPLATE_GENERATORS = {base: function() {
                    ...
                    template.push("<!-- ko if: $data.aspx && !$data.text -->", htmlBinding, "<!-- /ko -->", "<!-- ko if: !$data.aspx && $data.text -->", textBinding, "<!-- /ko -->", "<!-- ko ifnot: $.isPlainObject($data) -->", primitiveBinding, "<!-- /ko -->", "</div>");
        ...
        DEFAULT_ITEM_TEMPLATE_GENERATORS.dxTabs = function() {
            ...
            template = template.replace("<!-- ko if: !$data.aspx && $data.text -->", "<!-- ko if: !$data.aspx && ($data.text || $data.icon || $data.iconSrc) -->").replace(baseTextBinding, textBinding);
            return template
        };
