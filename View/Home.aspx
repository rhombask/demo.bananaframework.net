<%@ Page Title="홈" Language="C#" MasterPageFile="~/Control/Web.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="demo.bananaframework.net.View.Home" %>
...
※ 바나나 프레임워크의 라이선스 정책에 대해서는 여기( <a href="http://www.bananaframework.net/View/License.aspx" target="_blank">http://www.bananaframework.net/View/License.aspx</a> )를 참고하세요.<br />
※ 본 템플릿을 제대로 구동하기 위해서는 바나나 프레임워크가 우선 설치되어야 합니다.<br />
※ 바나나 프레임워크는 개인 개발자에게 무료로 배포되고 있습니다. 설치 파일은 여기 ( <a href="http://www.bananaframework.net/View/Download.aspx" target="_blank">http://www.bananaframework.net/View/Download.aspx</a> )를 클릭하세요.<br />
※ /Control/Web.Maste 및 /Control/Popup.Master에서 구글 Analytics 관련 함수는 지우고 이용하시기 바랍니다.<br />
