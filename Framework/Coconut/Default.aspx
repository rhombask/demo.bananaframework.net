...
<asp:Content ID="Content1" ContentPlaceHolderID="_cphHead" runat="server">
	...
	<script type="text/javascript" src="/Common/Scripts/devexpress-web-14.1/js/dx.chartjs.js"></script>
	<script type="text/javascript" src="/Common/Scripts/toastr/toastr.min.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="_cphContent" runat="server">
	...
	<div class="row">
		<div class="col-sm-6">
			<div class="chart-item-bg">
				...
				<div class="chart-entry-view">
					<div class="chart-entry-label">Pageviews
							</div>
				...
				<div class="chart-entry-view">
					<div class="chart-entry-label">Visitors
							</div>
					<div class="chart-entry-value">
				...
				<div class="chart-entry-view">
					<div class="chart-entry-label">Converted Sales
							</div>
					<div class="chart-entry-value">
		...
		<div class="col-sm-6">
			...
			<div class="chart-item-bg">
				<div class="chart-label">
					<div id="Div1" class="h1 text-secondary text-bold" data-count="this" data-from="0.00" data-to="67.35" data-suffix="%" data-duration="1.5">0.00%</div>
